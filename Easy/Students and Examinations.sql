...
SELECT  S.student_id, S.student_name, S.subject_name, COALESCE(E.attended_exams, 0)
FROM studentCTE S LEFT JOIN examCTE E ON E.student_id = S.student_id 
and E.subject_name = S.subject_name;

CREATE TABLE student(student_id INT, student_name VARCHAR(40));
CREATE TABLE examination(student_id INT, subject_name VARCHAR(40));

CREATE TABLE subjects(subject_name VARCHAR(40));
